...
main() {
	...
	default_username=${GIT_DEPLOY_USERNAME:-weslleyaraujo}
	default_email=${GIT_DEPLOY_EMAIL:-weslleyaraujo20@gmail.com}

	#repository to deploy to. must be readable and writable.
	repo=${GIT_DEPLOY_REPO:-https://github.com/weslleyaraujo/react-flux-puzzle.git}
